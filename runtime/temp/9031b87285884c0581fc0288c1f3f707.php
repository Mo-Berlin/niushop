<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"template/shop\default\Login\register.html";i:1513303782;s:45:"template/shop\default\Login\registerBase.html";i:1513303782;s:35:"template/shop\default\urlModel.html";i:1513303782;s:38:"template/shop\default\loginTopNav.html";i:1513303782;}*/ ?>
<!DOCTYPE html>
...
<!--整站改色 _start-->
<link type="text/css" rel="stylesheet" href="__TEMP__/<?php echo $style; ?>/public/css/color-style.css"/>
<!-- logo样式 -->
...
<script type="text/javascript" src="__TEMP__/<?php echo $style; ?>/public/js/register.js"></script>
...
<div class="header w990">
	<div class="logo-info">
		<a href="<?php echo __URL('SHOP_MAIN'); ?>" class="web-logo-a"><img alt="" src="<?php echo __IMG($web_info['logo']); ?>" class="weblogo"/></a>
	</div>
</div>
...
<div class="reg-type">
	<p class="login-info">
		我已经注册，现在就<a href="<?php echo __URL('SHOP_MAIN/login/index'); ?>" title="去登录" class="color">&nbsp;登录</a>
	</p>
	<ul class="clearfix">
		<?php if(strpos($reg_config['register_info'],'plain') !== false): ?>
		<li <?php if($login_type == 'plain'): ?>class="active" <?php endif; ?>><a <?php if($login_type == 'plain'): ?>href="javascript:void(0);"<?php else: ?>href="<?php echo __URL('SHOP_MAIN/login/register'); ?>"<?php endif; ?>>普通注册</a></li>
		<?php endif; if(strpos($reg_config['register_info'],'mobile') !== false): ?>
		<li <?php if($login_type == 'mobile'): ?>class="active" <?php endif; ?>><a <?php if($login_type == 'mobile'): ?>href="javascript:void(0);"<?php else: ?>href="<?php echo __URL('SHOP_MAIN/login/mobile'); ?>"<?php endif; ?>>手机注册</a></li>
		<?php endif; if(strpos($reg_config['register_info'],'email') !== false): ?>
		<li <?php if($login_type == 'email'): ?>class="active" <?php endif; ?>><a <?php if($login_type == 'email'): ?>href="javascript:void(0);"<?php else: ?>href="<?php echo __URL('SHOP_MAIN/login/email'); ?>"<?php endif; ?>>邮箱注册</a></li>
		<?php endif; ?>
	</ul>
</div>
				<div class="reg-wrap">
							...
							<div class="form-group m-10">
								...
								<div class="form-control-box">
									<label for="remember1">
										...
										<span><?php echo lang('read_and_agreed'); ?><a href="<?php echo __URL('SHOP_MAIN/helpcenter/index','id=17&class_id=6'); ?>" class="user_protocol"  target="_blank">《用户注册协议》</a></span>
										&nbsp;&nbsp;&nbsp;&nbsp;
...
<div id="user_protocol" style="display: none;">
	<div class="protocol">
		<div class="protocol-con">
			...
			<p>3.6用户同意，<?php echo $platform_shopname; ?>有权使用用户的注册信息、用户名、密码等信息，登录进入用户的注册账户，进行证据保全，包括但不限于公证、见证等。</p>
