<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:34:"template/platform\Index\index.html";i:1513303780;s:27:"template/platform\base.html";i:1513303780;s:44:"template/platform\controlCommonVariable.html";i:1513303780;s:31:"template/platform\urlModel.html";i:1513303780;s:33:"template/platform\openDialog.html";i:1513303780;}*/ ?>
<!DOCTYPE html>
...
function onloadWeiXinFansChart() {
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/index/getuserregchartcount'); ?>",
		async : true,
		success : function(data) {	
...
function onloadOrderChart() {
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/index/getorderchartcount'); ?>",
		async : true,
		success : function(data) {	
...
function getGoodsSalesCharts(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/index/getgoodssaleschartcount'); ?>",
		async : true,
		success : function(data) {	
				saleUnit = "元";
...
function getShopCreateCharts(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/index/getshopcreatenumchartcount'); ?>",
		async : true,
		success : function(data) {	
				saleUnit = "家";
...
function getgoodsCreateCharts(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/index/getgoodscreatechartcount'); ?>",
		async : true,
		success : function(data) {	
				saleUnit = "件";
...
function getGoodsCreateCount(){
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/Index/getgoodscreatecount'); ?>",
		async : true,
		success : function(data) {	
...
function getUserRegCount(){
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/index/getuserregcount'); ?>",
		async : true,
		success : function(data) {	
...
function getShopCreateCount(){
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/index/getshopcreatecount'); ?>",
		async : true,
		success : function(data) {	
