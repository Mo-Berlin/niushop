<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:39:"template/adminblue/Shop/shopConfig.html";i:1513303780;s:28:"template/adminblue/base.html";i:1513303780;s:45:"template/adminblue/controlCommonVariable.html";i:1513303780;s:32:"template/adminblue/urlModel.html";i:1513303780;s:34:"template/adminblue/pageCommon.html";i:1513303780;s:34:"template/adminblue/openDialog.html";i:1513303780;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>店铺等级:</dt>
		<dd>
			<p><?php echo $shop_info['instance_type_info']['type_name']; ?></p>
		</dd>
	</dl>
	<dl>
		<dt>店铺名称:</dt>
		<dd>
			<p><?php echo $shop_info['base_info']['shop_name']; ?></p>
		</dd>
	</dl>
	<dl>
		<dt>店铺类型:</dt>
		<dd>
			<p><?php echo $shop_info['group_info']['group_name']; ?></p>
		</dd>
	</dl>
	<dl>
		<dt>店铺logo:</dt>
		<dd>
			<div class="class-logo"><p><img id="imgLogo"src="<?php echo __IMG($shop_info['base_info']['shop_logo']); ?>" ></p></div>
			<div class="upload-btn">
				<span>
					<input class="input-file" name="file_upload" id="uploadImg" type="file" onchange="imgUpload(this);">
					<input type="hidden"id="Logo"value="<?php echo $shop_info['base_info']['shop_logo']; ?>"/>
				</span>
	...
	<dl>
		<dt>横幅:</dt>
		<dd>
			<div class="class-logo"><p style="width: 600px;"><img id="imgLogo1"src="<?php echo __IMG($shop_info['base_info']['shop_banner']); ?>" ></p></div>
			<div class="upload-btn"> 
				<span>
					<input class="input-file" name="file_upload" id="uploadImg1" type="file" onchange="imgUpload(this);">
					<input type="hidden"id="Logo1"value="<?php echo $shop_info['base_info']['shop_banner']; ?>"/>
				</span>
				<p><i class="fa fa-cloud-upload"></i>上传图片</p>
			</div>
			<p class="hint"><span style="color:orange;">建议使用宽600像素-高60像素内的GIF或PNG透明图片；点击下方"提交"按钮后生效。</span></p>
	...
	<dl>
		<dt>店铺头像:</dt>
		<dd>
			<div class="class-logo"><p><img id="imgLogo2"src="<?php echo __IMG($shop_info['base_info']['shop_avatar']); ?>" ></p></div>
			<div class="upload-btn"> 
				<span>
					<input class="input-file" name="file_upload" id="uploadImg2" type="file" onchange="imgUpload(this);">
					<input type="hidden"id="Logo2"value="<?php echo $shop_info['base_info']['shop_avatar']; ?>"/>
				</span>
				<p><i class="fa fa-cloud-upload"></i>上传图片</p>
			</div>
			<p class="hint"><span style="color:orange;">建议使用宽600像素-高60像素内的GIF或PNG透明图片；点击下方"提交"按钮后生效。</span></p>
	...
	<dl>
		<dt>QQ:</dt>
		<dd>
			<p><input id="shop_qq" type="text" value="<?php echo $shop_info['base_info']['shop_qq']; ?>" class="input-common"></p>
	...
	<dl>
		<dt>阿里旺旺:</dt>
		<dd>
			<p><input id="shop_ww" type="text" value="<?php echo $shop_info['base_info']['shop_ww']; ?>" class="input-common"></p>
	...
	<dl>
		<dt>商家电话:</dt>
		<dd>
			<p><input id="shop_phone" type="text" value="<?php echo $shop_info['base_info']['shop_phone']; ?>" class="input-common"></p>
	...
	<dl>
		<dt>seo关键字:</dt>
		<dd>
			<p><input id="shop_keywords" type="text" value="<?php echo $shop_info['base_info']['shop_keywords']; ?>" class="input-common"></p>
	...
	<dl>
		<dt>seo描述:</dt>
		<dd>
			<p><textarea id="shop_description"><?php echo $shop_info['base_info']['shop_description']; ?></textarea> </p>
...
function setShopConfigAjax(){
	...
	$.ajax({
		...
		success:function (data) {
			if (data["code"] > 0) {
				showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/Shop/shopConfig'); ?>");
			}else{
