<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"template/platform\Login\login.html";i:1525319251;s:33:"template/platform\openDialog.html";i:1513303780;}*/ ?>
			...
			<form id="AdminLoginModel" name="AdminLoginModel" method="post" autocomplete="off">
				<div class="input-text-box">
					<div class="form-group">
						...
						<div class="js-info-username-error tip-error animated fadeInLefts" style="animation-duration: 0.2s; display:none;width: 100px;left:315px;">
					...
					<div class="form-group">
						...
						<div class="js-info-password-error tip-error animated fadeInLefts" style="animation-duration: 0.2s; display:none;width: 100px;left:315px;">
<!-- 							<div class="tip-arrow"></div> -->
							<div class="tip-inners"></div>
						</div>
					</div>
...
function login() {
	...
	if (username == null || username ==""){
        $(".js-info-username-error").show();
        $(".js-info-username-error").text('请输入账户名');
	}
	if (password == null || password == ""){
        $(".js-info-password-error").show();
        $(".js-info-password-error").text('请输入密码');
	}
